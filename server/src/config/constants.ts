...
export const SOCIAL_ACCOUNT_INTELLIGENCE_JOB_CONCURRENCY = Number(
  process.env.SOCIAL_ACCOUNT_INTELLIGENCE_JOB_CONCURRENCY || 1
);
export const SOCIAL_ACCOUNT_INTELLIGENCE_INITIAL_POST_LIMIT = Number(
  process.env.SOCIAL_ACCOUNT_INTELLIGENCE_INITIAL_POST_LIMIT || 30
);
export const SOCIAL_ACCOUNT_INTELLIGENCE_VISUAL_SAMPLE_LIMIT = Number(
  process.env.SOCIAL_ACCOUNT_INTELLIGENCE_VISUAL_SAMPLE_LIMIT || 8
);
export const SOCIAL_ACCOUNT_INTELLIGENCE_STALE_MS = Number(
  process.env.SOCIAL_ACCOUNT_INTELLIGENCE_STALE_MS || 24 * 60 * 60_000
);
export const SOCIAL_ACCOUNT_INTELLIGENCE_SWEEP_INTERVAL_MS = Number(
  process.env.SOCIAL_ACCOUNT_INTELLIGENCE_SWEEP_INTERVAL_MS || 60 * 60_000
);
