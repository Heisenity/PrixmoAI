...
const TRANSCRIPTION_CACHE_TTL_MS = 10 * 60_000;
const TRANSCRIPTION_CACHE_MAX_ENTRIES = 60;
const TRANSCRIPTION_SCRIPT_NORMALIZATION_TIMEOUT_MS = 15_000;
...
const transcriptionResponseCache = new Map<string, CachedTranscriptionEntry>();
...
const LANGUAGE_TRANSCRIPTION_GUIDES: Record<string, LanguagePromptGuide> = {
  bn: {
  ...
  hi: {
    ...
    cleanupPrompt:
      'हिंदी ASR पाठ। देवनागरी, वर्तनी, शब्द-विराम, विराम-चिह्न, ध्वन्यात्मक ASR गलतियाँ और overlap repetition ठीक करो। अर्थ, वाक्य-क्रम या शब्द मत बदलो। रोमन हिंदी हो तो देवनागरी में दो। code-mixed brand/platform/technical शब्दों का सबसे स्वाभाविक लिखित रूप रखो।',
    contextLabel: 'हाल का संदर्भ',
    vocabularyLabel: 'हाल के शब्द',
    cleanupSystemPrompt:
      'तुम हिंदी speech-to-text normalizer हो। केवल ASR की स्पष्ट वर्तनी, लिपि, spacing, punctuation और overlap duplication ठीक करो। अर्थ, intent, sentence order या wording मत बदलो। अनुवाद, सारांश, paraphrase या नए शब्द मत जोड़ो।',
  },
  ur: {
    languageName: 'Urdu',
    prompt: 'اردو گفتگو۔ صرف اردو رسم الخط میں لکھو۔ ترجمہ یا رومن مت دو۔ نام اور برانڈ جیسے بولے گئے ہیں ویسے رکھو۔',
    cleanupPrompt:
      'اردو ASR متن۔ صرف املا، فاصلہ، رموزِ اوقاف، رسم الخط، واضح صوتی ASR غلطیاں اور overlap repetition درست کرو۔ مطلب، جملے کی ترتیب یا الفاظ نہ بدلو۔ انگریزی یا رومن ہو تو اردو رسم الخط میں دو۔ code-mixed brand/platform/technical الفاظ کی فطری تحریری شکل برقرار رکھو۔',
    contextLabel: 'حالیہ سیاق',
    vocabularyLabel: 'حالیہ الفاظ',
    cleanupSystemPrompt:
      'تم اردو speech-to-text normalizer ہو۔ صرف واضح ASR املا، رسم الخط، spacing، punctuation اور overlap duplication درست کرو۔ مطلب، intent، sentence order یا لفظی مواد نہ بدلو۔ ترجمہ، خلاصہ، paraphrase یا نئے الفاظ مت شامل کرو۔',
  },
  ta: {
    languageName: 'Tamil',
    ...
    cleanupPrompt:
      'தமிழ் ASR உரை. தமிழ் எழுத்து, எழுத்துப்பிழை, இடைவெளி, குறியீட்டுப் பிழை, தெளிவான ஒலிப்பிழை ASR தவறுகள் மற்றும் overlap repetition மட்டும் சரி செய். அர்த்தம், வாக்கிய வரிசை அல்லது சொற்களை மாற்றாதே. Roman அல்லது English இருந்தால் தமிழில் கொடு. code-mixed brand/platform/technical சொற்களுக்கு இயல்பான எழுத்து வடிவத்தை வைத்திரு.',
    contextLabel: 'சமீபப் பின்னணி',
    vocabularyLabel: 'சமீபச் சொற்கள்',
    cleanupSystemPrompt:
      'நீ தமிழ் speech-to-text normalizer. தெளிவான ASR எழுத்துப்பிழை, லிபி, spacing, punctuation மற்றும் overlap duplication மட்டும் சரி செய். அர்த்தம், நோக்கம், சொல் வரிசை அல்லது உள்ளடக்கச் சொற்களை மாற்றாதே. மொழிபெயர்ப்பு, சுருக்கம், paraphrase அல்லது புதிய சொற்கள் சேர்க்காதே.',
  },
  te: {
    languageName: 'Telugu',
    prompt: 'తెలుగు మాట. తెలుగులోనే రాయండి. అనువాదం లేదా రోమనైజేషన్ వద్దు. పేర్లు, బ్రాండ్‌లు ఎలా వినిపించాయో అలా ఉంచండి.',
    cleanupPrompt:
      'తెలుగు ASR పాఠ్యం. తెలుగు లిపి, వర్ణదోషం, ఖాళీలు, విరామచిహ్నాలు, స్పష్టమైన ధ్వన్యాత్మక ASR తప్పులు మరియు overlap repetition మాత్రమే సరిచేయండి. అర్థం, వాక్య క్రమం లేదా పదాలను మార్చవద్దు. English లేదా Roman ఉంటే తెలుగులోకి మార్చండి. code-mixed brand/platform/technical పదాలకు సహజమైన లిఖిత రూపాన్ని ఉంచండి.',
    contextLabel: 'ఇటీవలి సందర్భం',
    vocabularyLabel: 'ఇటీవలి పదాలు',
    cleanupSystemPrompt:
      'మీరు తెలుగు speech-to-text normalizer. స్పష్టమైన ASR వర్ణదోషం, లిపి, spacing, punctuation మరియు overlap duplication మాత్రమే సరిచేయండి. అర్థం, ఉద్దేశ్యం, పదక్రమం లేదా ముఖ్య పదాలను మార్చవద్దు. అనువాదం, సారాంశం, paraphrase లేదా కొత్త పదాలు జోడించవద్దు.',
  },
  ml: {
    ...
    cleanupPrompt:
      'മലയാളം ASR വാചകം. മലയാള ലിപി, അക്ഷരപ്പിശക്, ഇടവേള, പങ്ക്ചുവേഷൻ, വ്യക്തമായ ശബ്ദാധിഷ്ഠിത ASR പിശകുകൾ, overlap repetition എന്നിവ മാത്രം ശരിയാക്കുക. അർത്ഥം, വാക്യക്രമം അല്ലെങ്കിൽ വാക്കുകൾ മാറ്റരുത്. English അല്ലെങ്കിൽ Roman ഉണ്ടെങ്കിൽ മലയാളത്തിലാക്കുക. code-mixed brand/platform/technical വാക്കുകളുടെ സ്വാഭാവിക എഴുത്തുരൂപം നിലനിർത്തുക.',
    contextLabel: 'സമീപകാല പ്രസംഗം',
    vocabularyLabel: 'സമീപകാല പദങ്ങൾ',
    cleanupSystemPrompt:
      'നീ മലയാളം speech-to-text normalizer ആണ്. വ്യക്തമായ ASR അക്ഷരപ്പിശക്, ലിപി, spacing, punctuation, overlap duplication എന്നിവ മാത്രം ശരിയാക്കുക. അർത്ഥം, ഉദ്ദേശ്യം, വാക്കുകളുടെ ക്രമം അല്ലെങ്കിൽ ഉള്ളടക്ക വാക്കുകൾ മാറ്റരുത്. വിവർത്തനം, ചുരുക്കം, paraphrase, പുതിയ വാക്കുകൾ എന്നിവ ചേർക്കരുത്.',
  },
  kn: {
    languageName: 'Kannada',
    prompt: 'ಕನ್ನಡ ಮಾತು. ಕನ್ನಡದಲ್ಲೇ ಬರೆಯಿರಿ. ಅನುವಾದ ಅಥವಾ ರೋಮನ ಲಿಪಿ ಬೇಡ. ಹೆಸರು, ಬ್ರ್ಯಾಂಡ್ ಕೇಳಿದ ಹಾಗೆಯೇ ಇಡಿ.',
    cleanupPrompt:
      'ಕನ್ನಡ ASR ಪಠ್ಯ. ಕನ್ನಡ ಲಿಪಿ, ಸ್ಪಷ್ಟ ಉಚ್ಚಾರಣಾಧಾರಿತ ASR ಅಕ್ಷರ ದೋಷ, ಖಾಲಿ ಜಾಗ, ವಿರಾಮ ಚಿಹ್ನೆ ಮತ್ತು overlap repetition ಮಾತ್ರ ಸರಿಪಡಿಸಿ. ಅರ್ಥ, ವಾಕ್ಯ ಕ್ರಮ ಅಥವಾ ಪದಗಳನ್ನು ಬದಲಿಸಬೇಡಿ. English ಅಥವಾ Roman ಇದ್ದರೆ ಕನ್ನಡಕ್ಕೆ ಬದಲಿಸಿ. code-mixed brand/platform/technical ಪದಗಳ ಸ್ವಾಭಾವಿಕ ಲಿಖಿತ ರೂಪವನ್ನು ಉಳಿಸಿ.',
    contextLabel: 'ಇತ್ತೀಚಿನ ಸಂದರ್ಭ',
    vocabularyLabel: 'ಇತ್ತೀಚಿನ ಪದಗಳು',
    cleanupSystemPrompt:
      'ನೀವು ಕನ್ನಡ speech-to-text normalizer. ಸ್ಪಷ್ಟ ASR ಅಕ್ಷರದೋಷ, ಲಿಪಿ, spacing, punctuation ಮತ್ತು overlap duplication ಮಾತ್ರ ಸರಿಪಡಿಸಿ. ಅರ್ಥ, ಉದ್ದೇಶ, ಪದಕ್ರಮ ಅಥವಾ ವಿಷಯಪದಗಳನ್ನು ಬದಲಿಸಬೇಡಿ. ಅನುವಾದ, ಸಂಕ್ಷೇಪ, paraphrase ಅಥವಾ ಹೊಸ ಪದಗಳನ್ನು ಸೇರಿಸಬೇಡಿ.',
  },
  pa: {
    languageName: 'Punjabi',
    prompt: 'ਪੰਜਾਬੀ ਗੱਲਬਾਤ। ਗੁਰਮੁਖੀ ਵਿੱਚ ਹੀ ਲਿਖੋ। ਅਨੁਵਾਦ ਜਾਂ ਰੋਮਨ ਨਾ ਦਿਓ। ਨਾਮ ਅਤੇ ਬ੍ਰਾਂਡ ਜਿਵੇਂ ਬੋਲੇ ਗਏ ਹਨ ਤਿਵੇਂ ਰੱਖੋ।',
    cleanupPrompt:
      'ਪੰਜਾਬੀ ASR ਲਿਖਤ। ਸਿਰਫ ਗੁਰਮੁਖੀ, ਵਰਤਨੀ, ਖਾਲੀ ਥਾਂ, ਵਿਸ਼ਰਾਮ-ਚਿੰਨ੍ਹ, ਸਪੱਸ਼ਟ ਧੁਨੀ-ਅਧਾਰਿਤ ASR ਗਲਤੀਆਂ ਅਤੇ overlap repetition ਠੀਕ ਕਰੋ। ਅਰਥ, ਵਾਕ ਕ੍ਰਮ ਜਾਂ ਸ਼ਬਦ ਨਾ ਬਦਲੋ। English ਜਾਂ Roman ਹੋਵੇ ਤਾਂ ਗੁਰਮੁਖੀ ਵਿੱਚ ਦਿਓ। code-mixed brand/platform/technical ਸ਼ਬਦਾਂ ਦੀ ਕੁਦਰਤੀ ਲਿਖਤ ਰੱਖੋ।',
    contextLabel: 'ਹਾਲੀਆ ਸੰਦਰਭ',
    vocabularyLabel: 'ਹਾਲੀਆ ਸ਼ਬਦ',
    cleanupSystemPrompt:
      'ਤੂੰ ਪੰਜਾਬੀ speech-to-text normalizer ਹੈਂ। ਸਿਰਫ ਸਪੱਸ਼ਟ ASR ਵਰਤਨੀ, ਲਿਪੀ, spacing, punctuation ਅਤੇ overlap duplication ਠੀਕ ਕਰ। ਅਰਥ, intent, sentence order ਜਾਂ content words ਨਾ ਬਦਲ। ਅਨੁਵਾਦ, ਸਾਰ, paraphrase ਜਾਂ ਨਵੇਂ ਸ਼ਬਦ ਨਾ ਜੋੜ।',
  },
  en: {
    languageName: 'English',
    prompt:
      'Spoken English. Write in English only. No translation. Keep names, brands, and technical terms as spoken.',
    cleanupPrompt:
      'English ASR text. Fix only obvious spelling, spacing, punctuation, casing, and chunk-overlap repetition. Preserve exact meaning and wording.',
    contextLabel: 'Recent context',
    vocabularyLabel: 'Recent terms',
  },
};

const LANGUAGE_SCRIPT_GUIDES: Record<string, ScriptGuide> = {
  bn: {
    name: 'Bengali script',
    charPattern: /[\u0980-\u09FF]/gu,
  },
...
const dedupeImmediateRepeatedPhrases = (value: string) => {
  ...
  for (let spanLength = maxSpan; spanLength >= 3; spanLength -= 1) {
    ...
    for (let startIndex = Math.max(0, leading.length - spanLength - 4); startIndex < leading.length; startIndex += 1) {
      ...
      const matches = candidate.every(
        (token, index) => token === trailing[index]
      );
...
const summarizeForDebug = (value: string) => {
  const normalized = normalizeTranscriptText(value);
...
const buildTranscriptDiffHint = (rawTranscript: string, cleanedTranscript: string) => {
...
const estimateTranscriptChangeRatio = (rawTranscript: string, cleanedTranscript: string) => {
  const rawTokens = normalizeTranscriptText(rawTranscript).split(/\s+/).filter(Boolean);
  const cleanedTokens = normalizeTranscriptText(cleanedTranscript)
    .split(/\s+/)
    .filter(Boolean);
...
const summarizeBinaryHeader = (binary: Buffer) =>
...
const trimToBudget = (value: string, maxBytes: number) => {
...
const trimTailToBudget = (value: string, maxBytes: number) => {
  if (Buffer.byteLength(value, 'utf8') <= maxBytes) {
    return { text: value, truncated: false };
  }
...
const trimToCharacterBudget = (value: string, maxChars: number) => {
...
const clampPromptToProviderLimits = (value: string) => {
  const byteTrimmed = trimToBudget(value, TRANSCRIPTION_PROMPT_MAX_BYTES);
  const charTrimmed = trimToCharacterBudget(
    byteTrimmed.text,
    TRANSCRIPTION_PROVIDER_PROMPT_MAX_CHARS
  );
...
const resolveLanguageHint = (languageHint?: string) => {
...
const buildBinaryHash = (value: Buffer | string) =>
...
const readCachedTranscription = (key: string) => {
...
const writeCachedTranscription = (key: string, result: AudioTranscriptionResult) => {
...
const buildVocabularyHints = (previousContext?: string, language?: string) => {
  if (!previousContext) {
    return '';
  }
  ...
  return trimToBudget(
    Array.from(uniqueTokens).join(', '),
    TRANSCRIPTION_VOCABULARY_MAX_BYTES
  ).text;
};

const buildContextHints = (previousContext?: string, language?: string) => {
  ...
  if (language === 'bn') {
    const bengaliTokens =
      normalizedContext.match(/[\u0980-\u09FFA-Za-z0-9][\u0980-\u09FFA-Za-z0-9\-_.]*/gu) ??
      [];
...
const shouldNormalizeScript = (value: string, language: string) => {
...
const buildConservativeCleanupPrompt = (language: string, transcript: string) => {
  const guide = LANGUAGE_TRANSCRIPTION_GUIDES[language];
  const scriptGuide = LANGUAGE_SCRIPT_GUIDES[language];
...
const countTranscriptTokens = (value: string) =>
...
const canonicalizeComparisonToken = (value: string) =>
  value
    .normalize('NFC')
    .replace(/^[\p{P}\p{S}]+|[\p{P}\p{S}]+$/gu, '')
    .trim();

const getComparableTokens = (value: string) =>
  tokenizeTranscript(value)
    .map((token) => canonicalizeComparisonToken(token).toLowerCase())
    .filter(Boolean);

const estimateComparableTokenOverlap = (source: string, target: string) => {
...
const hasRepeatedTokenRun = (value: string, minRunLength = 3) => {
...
const hasSuspiciousNumericWordAttachment = (value: string) =>
  /(?:[\u09E6-\u09EF0-9][\u09E6-\u09EF0-9]+[\p{L}]+|[\p{L}]+[\u09E6-\u09EF0-9]{2,})/u.test(
    normalizeTranscriptText(value)
  );
...
const removeSemanticRepetition = (value: string) => {
...
const buildBengaliVerifierPrompt = (
...
const shouldRejectHindiCleanupDrift = (
  rawTranscript: string,
  cleanedTranscript: string,
  needsScriptRecovery: boolean
) => {
...
const shouldRejectBengaliCleanupDrift = (
  rawTranscript: string,
  cleanedTranscript: string,
  needsScriptRecovery: boolean
) => {
  ...
  let changedTokenCount = Math.abs(
    normalizedRawTokens.length - normalizedCleanedTokens.length
  );

  for (
    let index = 0;
    index < Math.min(normalizedRawTokens.length, normalizedCleanedTokens.length);
    index += 1
  ) {
...
const shouldAcceptCleanupOutput = (
  rawTranscript: string,
  cleanedTranscript: string,
  language: string,
  needsScriptRecovery: boolean
  ...
  if (
    tokenRatio < TRANSCRIPTION_CLEANUP_MIN_TOKEN_RATIO ||
  ...
  if (
    language === 'bn' &&
    shouldRejectBengaliCleanupDrift(
      normalizedRaw,
      normalizedCleaned,
      needsScriptRecovery
    )
  ...
  if (
    shouldRejectConservativeCleanupDrift(
      normalizedRaw,
      normalizedCleaned,
      language,
      needsScriptRecovery
...
const cleanupTranscriptOrthography = async (
  transcript: string,
  language: string,
  apiKey: string,
  previousContext?: string,
  ...
  const needsScriptRecovery =
    language !== 'en' && shouldNormalizeScript(normalizedTranscript, language);
  ...
  const runCleanupWithProvider = async (
    provider: 'groq' | 'gemini',
    prompt: string
  ) => {
    const timeoutMs =
      provider === 'gemini'
        ? Math.min(GEMINI_GENERATION_TIMEOUT_MS, TRANSCRIPTION_SCRIPT_NORMALIZATION_TIMEOUT_MS)
        : Math.min(
            GROQ_TRANSCRIPTION_TIMEOUT_MS,
            TRANSCRIPTION_SCRIPT_NORMALIZATION_TIMEOUT_MS
          );
    ...
    const payload = await withTimeout(
      ...
      async (signal) => {
        ...
        const response = await fetch(
          `https://generativelanguage.googleapis.com/v1beta/models/${DEFAULT_GEMINI_MODEL}:generateContent?key=${geminiApiKey}`,
          {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
  ...
  const runCleanup = async (prompt: string) => {
    if (language !== 'bn') {
    ...
    try {
      ...
      try {
        ...
        console.warn('[transcription] Bengali cleanup fallback failed; preserving raw transcript', {
          error:
            geminiError instanceof Error ? geminiError.message : 'unknown Gemini cleanup error',
        });
  ...
  if (
    ...
    const verifierPrompt = buildBengaliVerifierPrompt(
    ...
    if (
      ...
      const verifiedOverlap = previousContext
        ...
        : 0;
      const currentSuspiciousScore =
        Number(hasRepeatedTokenRun(cleanedTranscript)) +
        Number(hasSuspiciousNumericWordAttachment(cleanedTranscript));
      const verifiedSuspiciousScore =
        Number(hasRepeatedTokenRun(verifiedTranscript)) +
        Number(hasSuspiciousNumericWordAttachment(verifiedTranscript));

      if (
        verifiedSuspiciousScore < currentSuspiciousScore ||
...
const summarizeSegmentQuality = (payload: GroqVerboseTranscriptionResponse | null) => {
  ...
  return {
    ...
    lowConfidenceSegments: segments.filter(
      (segment) =>
...
const shouldUseModelCleanup = ({
  ...
  qualitySummary: ReturnType<typeof summarizeSegmentQuality>;
}) => {
  if (stage !== 'final') {
    return false;
  }
  ...
  if (
    typeof qualitySummary.minAvgLogprob === 'number' &&
  ...
  if (
    typeof qualitySummary.maxNoSpeechProb === 'number' &&
  ...
  if (
    typeof qualitySummary.maxCompressionRatio === 'number' &&
...
const buildTranscriptionPrompt = (
  ...
  const trimmedContext = buildContextHints(
    previousContext,
    normalizedLanguage
  );
  const vocabularyHints = buildVocabularyHints(
    previousContext,
    normalizedLanguage
  );
...
const normalizeScriptConfusables = (value: string, language?: string) => {
  if (!value) {
    return value;
  }
...
const applyLanguageCorrections = (value: string, language?: string) => {
  const baseline = normalizeScriptConfusables(
    normalizeTranscriptText(value),
    language
  );
...
export const transcribeAudioWithGroq = async (
  ...
  if (binary.byteLength > TRANSCRIPTION_MAX_AUDIO_BYTES) {
    const maxMb = Math.round((TRANSCRIPTION_MAX_AUDIO_BYTES / (1024 * 1024)) * 10) / 10;
    throw new Error(
      `That recording is a little too chunky right now. Keep it under ${maxMb}MB and try again.`
    );
  }
  ...
  const builtPrompt = buildTranscriptionPrompt(
    authoritativeLanguageHint,
  ...
  const deterministicCorrection = applyLanguageCorrections(
    rawTranscript,
    effectiveDetectedLanguage
  );
  const deterministicTranscript = deterministicCorrection.text;
  const scriptMismatchDetected = shouldNormalizeScript(
  ...
  const cleanupResult =
    shouldRunModelCleanup
      ? await cleanupTranscriptOrthography(
          deterministicTranscript,
          effectiveDetectedLanguage,
          apiKey,
          input.previousContext,
  ...
  const transcriptCorrection = applyLanguageCorrections(
    cleanupResult.text || deterministicTranscript,
    effectiveDetectedLanguage
  );
  const cleanupChangedTranscript =
    normalizeTranscriptText(deterministicTranscript) !==
  ...
  const result: AudioTranscriptionResult = {
    ...
    segments: Array.isArray(payload?.segments)
      ? payload!.segments
          .map((segment) => {
            const segmentCorrection = applyLanguageCorrections(
              segment.text ?? '',
              effectiveDetectedLanguage
            );
  ...
  if (NODE_ENV !== 'production') {
    ...
    const cleanupChangeRatio = estimateTranscriptChangeRatio(
      rawTranscript,
      cleanedTranscript
    );
