...
exports.META_INSTAGRAM_APP_SECRET = exports.META_INSTAGRAM_APP_ID = exports.META_FACEBOOK_APP_SECRET = exports.META_FACEBOOK_APP_ID = exports.META_GRAPH_VERSION = exports.TRANSCRIPTION_MAX_AUDIO_BYTES = exports.GROQ_TRANSCRIPTION_TIMEOUT_MS = exports.GROQ_TRANSCRIPTION_MODEL = exports.GROQ_MAX_GENERATION_TIMEOUT_MS = exports.GROQ_STREAM_IDLE_TIMEOUT_MS = exports.GROQ_FIRST_TOKEN_TIMEOUT_MS = exports.GROQ_GENERATION_TIMEOUT_MS = exports.GEMINI_FALLBACK_GRACE_MS = exports.GEMINI_EMBEDDING_TIMEOUT_MS = exports.GEMINI_EMBEDDING_DIMENSION = exports.GEMINI_GENERATION_TIMEOUT_MS = exports.DEFAULT_GROQ_MODEL = exports.DEFAULT_GEMINI_EMBEDDING_MODEL = exports.DEFAULT_GEMINI_MODEL = exports.HISTORICAL_ARCHIVE_STARTUP_DELAY_MS = exports.HISTORICAL_ARCHIVE_LOCK_TTL_MS = exports.HISTORICAL_ARCHIVE_INTERVAL_MS = exports.HISTORICAL_ARCHIVE_ENABLED = exports.ADMIN_HEALTH_EVENT_RETENTION_DAYS = exports.RUNTIME_CACHE_TTL_MS = exports.OBSERVABILITY_ALERT_WINDOW_MS = exports.OBSERVABILITY_ALERT_FAILURE_THRESHOLD = exports.OBSERVABILITY_ALERT_WEBHOOK_URL = exports.JOB_CANCELLATION_TTL_MS = exports.JOB_RUNTIME_TTL_MS = exports.BULLMQ_WORKER_STALLED_INTERVAL_MS = exports.BULLMQ_WORKER_DRAIN_DELAY_SECONDS = exports.ANALYTICS_WORKER_IDLE_SHUTDOWN_MS = exports.GENERATION_WORKER_IDLE_SHUTDOWN_MS = exports.SCHEDULER_MAX_RETRY_ATTEMPTS = exports.SCHEDULER_PROCESSING_TIMEOUT_MS = exports.SCHEDULER_PROCESS_BATCH_SIZE = exports.CRON_SECRET = exports.START_BACKGROUND_WORKERS_ON_BOOT = exports.START_GENERATION_WORKERS_ON_BOOT = exports.LOW_REDIS_COMMAND_MODE = exports.BULLMQ_PREFIX = exports.REDIS_TLS = exports.REDIS_KEY_PREFIX = exports.REDIS_TOKEN = exports.REDIS_URL = exports.CLIENT_APP_URL = exports.SERVER_PUBLIC_URL = exports.NODE_ENV = exports.APP_PORT = void 0;
exports.SOCIAL_ACCOUNT_INTELLIGENCE_JOB_CONCURRENCY = exports.ANALYTICS_LEARNING_JOB_CONCURRENCY = exports.ANALYTICS_SYNC_JOB_CONCURRENCY = exports.SCHEDULER_PUBLISH_JOB_CONCURRENCY = exports.IMAGE_PROVIDER_OPEN_MS = exports.IMAGE_PROVIDER_FAILURE_THRESHOLD = exports.CONTENT_GENERATION_JOB_BACKOFF_MS = exports.CONTENT_GENERATION_JOB_ATTEMPTS = exports.CONTENT_GENERATION_JOB_CONCURRENCY = exports.IMAGE_GENERATION_JOB_BACKOFF_MS = exports.IMAGE_GENERATION_JOB_ATTEMPTS = exports.IMAGE_QUEUE_CONCURRENCY = exports.FREE_IMAGE_STANDARD_SPEED_DAILY_THRESHOLD = exports.FREE_IMAGE_NORMAL_QUEUE_DAILY_THRESHOLD = exports.IMAGE_RUNTIME_POLICIES = exports.PLAN_FEATURE_LIMITS = exports.PLAN_LIMITS = exports.IMAGE_SPEED_TIERS = exports.IMAGE_QUEUE_TIERS = exports.FEATURE_KEYS = exports.TREND_RESEARCH_MAX_INSIGHTS = exports.TREND_RESEARCH_MAX_CANDIDATES = exports.TREND_RESEARCH_CACHE_TTL_MS = exports.APIFY_RESULT_LIMIT = exports.APIFY_TIMEOUT_MS = exports.APIFY_API_BASE_URL = exports.TAVILY_SEARCH_RESULT_LIMIT = exports.TAVILY_SEARCH_QUERY_LIMIT = exports.TAVILY_SEARCH_TIMEOUT_MS = exports.TAVILY_SEARCH_API_BASE_URL = exports.BRAND_MEMORY_RERANK_CANDIDATE_COUNT = exports.BRAND_MEMORY_KEYWORD_CANDIDATE_COUNT = exports.BRAND_MEMORY_VECTOR_CANDIDATE_COUNT = exports.BRAND_MEMORY_MIN_SIMILARITY = exports.BRAND_MEMORY_MATCH_COUNT = exports.HASHTAG_VARIATION_COUNT = exports.CAPTION_VARIATION_COUNT = exports.isMetaInstagramOAuthConfigured = exports.isMetaFacebookOAuthConfigured = exports.isMetaOAuthConfigured = exports.ANALYTICS_SYNC_LOOKBACK_DAYS = exports.META_OAUTH_STATE_TTL_MS = exports.META_INSTAGRAM_OAUTH_SCOPES = exports.META_FACEBOOK_OAUTH_SCOPES = exports.META_OAUTH_DEBUG = exports.META_OAUTH_STATE_SECRET = exports.META_OAUTH_CONFIG_ID = exports.META_REDIRECT_URI = exports.META_INSTAGRAM_REDIRECT_URI = exports.META_FACEBOOK_REDIRECT_URI = void 0;
exports.SUBSCRIPTION_STATUSES = exports.SCHEDULED_POST_STATUSES = exports.SUPABASE_SOURCE_IMAGE_BUCKET = exports.R2_PUBLIC_BASE_URL = exports.R2_S3_ENDPOINT = exports.R2_SECRET_ACCESS_KEY = exports.R2_ACCESS_KEY_ID = exports.R2_ACCOUNT_ID = exports.R2_SOURCE_MEDIA_BUCKET = exports.IMAGE_BUCKETS = exports.BILLING_PLAN_CATALOG = exports.ANALYTICS_LEARNING_MAX_PATTERNS = exports.ANALYTICS_LEARNING_MIN_POSTS = exports.ANALYTICS_LEARNING_LOOKBACK_DAYS = exports.SOCIAL_ACCOUNT_INTELLIGENCE_SWEEP_INTERVAL_MS = exports.SOCIAL_ACCOUNT_INTELLIGENCE_STALE_MS = exports.SOCIAL_ACCOUNT_INTELLIGENCE_VISUAL_SAMPLE_LIMIT = exports.SOCIAL_ACCOUNT_INTELLIGENCE_INITIAL_POST_LIMIT = void 0;
...
exports.SCHEDULER_PROCESS_BATCH_SIZE = Number(process.env.SCHEDULER_PROCESS_BATCH_SIZE || 10);
exports.SCHEDULER_PROCESSING_TIMEOUT_MS = Number(process.env.SCHEDULER_PROCESSING_TIMEOUT_MS || 15 * 60000);
exports.SCHEDULER_MAX_RETRY_ATTEMPTS = Number(process.env.SCHEDULER_MAX_RETRY_ATTEMPTS || 3);
...
exports.OBSERVABILITY_ALERT_WEBHOOK_URL = process.env.OBSERVABILITY_ALERT_WEBHOOK_URL || '';
exports.OBSERVABILITY_ALERT_FAILURE_THRESHOLD = Number(process.env.OBSERVABILITY_ALERT_FAILURE_THRESHOLD || 5);
exports.OBSERVABILITY_ALERT_WINDOW_MS = Number(process.env.OBSERVABILITY_ALERT_WINDOW_MS || 5 * 60000);
exports.RUNTIME_CACHE_TTL_MS = Number(process.env.RUNTIME_CACHE_TTL_MS || 60000);
exports.ADMIN_HEALTH_EVENT_RETENTION_DAYS = Number(process.env.ADMIN_HEALTH_EVENT_RETENTION_DAYS || 14);
exports.HISTORICAL_ARCHIVE_ENABLED = readBoolean(process.env.HISTORICAL_ARCHIVE_ENABLED, exports.START_BACKGROUND_WORKERS_ON_BOOT && exports.NODE_ENV === 'production');
exports.HISTORICAL_ARCHIVE_INTERVAL_MS = Number(process.env.HISTORICAL_ARCHIVE_INTERVAL_MS || 6 * 60 * 60000);
exports.HISTORICAL_ARCHIVE_LOCK_TTL_MS = Number(process.env.HISTORICAL_ARCHIVE_LOCK_TTL_MS || 45 * 60000);
exports.HISTORICAL_ARCHIVE_STARTUP_DELAY_MS = Number(process.env.HISTORICAL_ARCHIVE_STARTUP_DELAY_MS || 60000);
exports.DEFAULT_GEMINI_MODEL = process.env.GEMINI_MODEL || 'gemini-2.5-flash';
exports.DEFAULT_GEMINI_EMBEDDING_MODEL = process.env.GEMINI_EMBEDDING_MODEL || 'gemini-embedding-001';
...
exports.GEMINI_EMBEDDING_DIMENSION = 768;
exports.GEMINI_EMBEDDING_TIMEOUT_MS = Number(process.env.GEMINI_EMBEDDING_TIMEOUT_MS || 12000);
...
exports.BRAND_MEMORY_MATCH_COUNT = Number(process.env.BRAND_MEMORY_MATCH_COUNT || 7);
exports.BRAND_MEMORY_MIN_SIMILARITY = Number(process.env.BRAND_MEMORY_MIN_SIMILARITY || 0.68);
exports.BRAND_MEMORY_VECTOR_CANDIDATE_COUNT = Number(process.env.BRAND_MEMORY_VECTOR_CANDIDATE_COUNT || 24);
exports.BRAND_MEMORY_KEYWORD_CANDIDATE_COUNT = Number(process.env.BRAND_MEMORY_KEYWORD_CANDIDATE_COUNT || 24);
exports.BRAND_MEMORY_RERANK_CANDIDATE_COUNT = Number(process.env.BRAND_MEMORY_RERANK_CANDIDATE_COUNT || 10);
exports.TAVILY_SEARCH_API_BASE_URL = trimTrailingSlash(process.env.TAVILY_SEARCH_API_BASE_URL || 'https://api.tavily.com');
exports.TAVILY_SEARCH_TIMEOUT_MS = Number(process.env.TAVILY_SEARCH_TIMEOUT_MS || 12000);
exports.TAVILY_SEARCH_QUERY_LIMIT = Number(process.env.TAVILY_SEARCH_QUERY_LIMIT || 3);
exports.TAVILY_SEARCH_RESULT_LIMIT = Number(process.env.TAVILY_SEARCH_RESULT_LIMIT || 6);
exports.APIFY_API_BASE_URL = trimTrailingSlash(process.env.APIFY_API_BASE_URL || 'https://api.apify.com');
exports.APIFY_TIMEOUT_MS = Number(process.env.APIFY_TIMEOUT_MS || 45000);
exports.APIFY_RESULT_LIMIT = Number(process.env.APIFY_RESULT_LIMIT || 12);
exports.TREND_RESEARCH_CACHE_TTL_MS = Number(process.env.TREND_RESEARCH_CACHE_TTL_MS || 10 * 60000);
exports.TREND_RESEARCH_MAX_CANDIDATES = Number(process.env.TREND_RESEARCH_MAX_CANDIDATES || 20);
exports.TREND_RESEARCH_MAX_INSIGHTS = Number(process.env.TREND_RESEARCH_MAX_INSIGHTS || 6);
...
exports.ANALYTICS_LEARNING_JOB_CONCURRENCY = Number(process.env.ANALYTICS_LEARNING_JOB_CONCURRENCY || 2);
exports.SOCIAL_ACCOUNT_INTELLIGENCE_JOB_CONCURRENCY = Number(process.env.SOCIAL_ACCOUNT_INTELLIGENCE_JOB_CONCURRENCY || 1);
exports.SOCIAL_ACCOUNT_INTELLIGENCE_INITIAL_POST_LIMIT = Number(process.env.SOCIAL_ACCOUNT_INTELLIGENCE_INITIAL_POST_LIMIT || 30);
exports.SOCIAL_ACCOUNT_INTELLIGENCE_VISUAL_SAMPLE_LIMIT = Number(process.env.SOCIAL_ACCOUNT_INTELLIGENCE_VISUAL_SAMPLE_LIMIT || 8);
exports.SOCIAL_ACCOUNT_INTELLIGENCE_STALE_MS = Number(process.env.SOCIAL_ACCOUNT_INTELLIGENCE_STALE_MS || 24 * 60 * 60000);
exports.SOCIAL_ACCOUNT_INTELLIGENCE_SWEEP_INTERVAL_MS = Number(process.env.SOCIAL_ACCOUNT_INTELLIGENCE_SWEEP_INTERVAL_MS || 60 * 60000);
exports.ANALYTICS_LEARNING_LOOKBACK_DAYS = Number(process.env.ANALYTICS_LEARNING_LOOKBACK_DAYS || 120);
exports.ANALYTICS_LEARNING_MIN_POSTS = Number(process.env.ANALYTICS_LEARNING_MIN_POSTS || 6);
exports.ANALYTICS_LEARNING_MAX_PATTERNS = Number(process.env.ANALYTICS_LEARNING_MAX_PATTERNS || 4);
...
exports.R2_SOURCE_MEDIA_BUCKET = process.env.R2_SOURCE_MEDIA_BUCKET ||
